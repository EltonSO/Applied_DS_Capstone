...
# Print unique launch site values to check data integrity
print("Unique Launch Sites in DataFrame:", spacex_df['Launch Site'].unique())
...
def get_pie_chart(entered_site):
    if entered_site == 'ALL':
        ...
        print(f"Filtered Data for {entered_site}:\n", filtered_df)
